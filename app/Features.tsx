    ...
    <div className="text-center py-16">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Link href="/services#certified-tutors">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 h-full text-left">
            <div className="flex items-start mb-8">
              ...
              <div className="ml-8 sm:ml-6 min-h-18">
        ...
        <Link href="/services#personalised-plans">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 h-full text-left">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              customised curriculum pacing, preferred teaching methodologies,
