      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
          ...
          <div className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <p>
              <strong>Google Analytics 4 Integration:</strong> This dashboard
              shows mock data. In production, it would connect to the GA4 API to
              fetch real-time analytics data.
            </p>
            <p>
              <strong>Real-time Updates:</strong> Data would be refreshed
              periodically or use GA4's real-time reporting API for live
              metrics.
            </p>
            <p>
              <strong>Custom Events:</strong> All enrollment events are tracked
              with custom parameters for detailed funnel analysis.
            </p>
            <p>
              <strong>Privacy Compliance:</strong> Analytics only run with user
              consent, respecting GDPR/CCPA requirements for Australian users.
            </p>
          </div>
        </div>
      </div>
