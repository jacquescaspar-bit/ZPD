    ...
    <div className="max-w-6xl mx-auto">
      ...
      <section className="mb-16">
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          ...
          exceptional educators. Our tutors are not just knowledgeable in their
          subjects – they are certified professionals with proven track records
          of helping students succeed. Each tutor undergoes a rigorous selection
        ...
        <ul className="list-disc list-inside text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6 space-y-2">
          ...
          <li>
            <strong>Background Checks:</strong> Thorough verification to ensure
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          Beyond credentials, we look for passion, patience, and the ability to
          connect with students of all ages and backgrounds. Our tutors stay
          current with the latest educational research and continuously refine
          their skills through ongoing professional development programs.
        </p>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          ...
          tutors with students. Our matching process considers multiple factors
        ...
        <ul className="list-disc list-inside text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6 space-y-2">
          ...
          <li>
            <strong>Age and Experience Level:</strong> Matching tutor experience
            with student grade level and maturity
          </li>
          <li>
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          ...
          re-matching to ensure every student finds their ideal tutor. Our goal
          is to create learning partnerships that inspire confidence and foster
      ...
      <section className="mb-16">
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          Our commitment to excellence doesn&apos;t end with hiring. We provide
          ongoing support to our tutors through:
        </p>
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          ...
          the forefront of educational excellence, providing your child with the
      ...
      <section className="mb-16">
        ...
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          ...
          success. They don&apos;t just teach subjects – they inspire curiosity,
          build confidence, and develop lifelong learning skills. Our tutors
          understand that education is about more than grades; it&apos;s about
          empowering students to reach their full potential and discover their
          passion for knowledge.
        </p>
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          With our expert tutors, your child will receive personalized attention
          in a supportive environment that celebrates progress and encourages
          growth. Contact us today to experience the difference that certified,
          caring educators can make in your child&apos;s educational journey.
        </p>
      </section>
