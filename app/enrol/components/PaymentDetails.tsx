...
import DiscountCodeSection from "@/enrol/components/DiscountCodeSection";
...
export interface PaymentDetailsProps {
  ...
  appliedPromoKind: "referral" | "promo" | "diagnostic_credit" | "none" | null;
  removePromo: () => void;
    ...
    >
      ...
      <DiscountCodeSection
        ...
        onPromoCodeChange={(value) => {
          void handlePromoCodeChange(value);
        }}
      />
