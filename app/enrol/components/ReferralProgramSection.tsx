...
const ReferralProgramSection: React.FC<ReferralProgramSectionProps> = ({
  ...
  <section className={`${SECTION_CARD_CLASS} p-8 space-y-6`}>
    ...
    <div className="bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-950/30 dark:to-blue-950/30 rounded-2xl p-6 border border-blue-200/50 dark:border-blue-800/50">
      ...
      <div className="flex gap-2 mb-4">
        <input
          readOnly
          className="flex-1 border border-white/60 dark:border-gray-700 bg-white/90 dark:bg-gray-950/40 px-4 py-3 rounded-2xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-400 focus:outline-none shadow-sm text-sm"
          value={referralLink ?? ""}
        />
        <button
          className="px-6 py-3 bg-blue-500 text-white rounded-2xl font-semibold hover:bg-blue-600 transition-colors duration-200 focus:ring-2 focus:ring-blue-400 focus:outline-none"
          type="button"
