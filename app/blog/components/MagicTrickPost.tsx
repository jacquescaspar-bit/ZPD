    ...
    >
      <header className="mb-6">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900 dark:text-white">
          The 47-Minute Magic Trick That Turns "I'm Dumb" Into "Wait, That's
          It?" (And How to Manufacture It On Demand)
        </h2>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
          Every child has that moment of frustration where learning feels
          impossible. 'I'm just dumb at maths,' they say. But what if there's a
          47-minute process that can turn that defeat into triumph, revealing
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          At ZPD Learning, we call it the diagnostic session – a carefully
          crafted 45-60 minute experience that doesn't just assess; it
          transforms. Using insights from the child's classroom teacher, our
          certified tutors guide the child through targeted activities that
          probe the edges of their understanding.
        </p>
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          The magic happens when the child encounters a challenge that's just
          right – not too easy, not too hard. With gentle scaffolding, they
          suddenly grasp the concept. 'Wait, that's it?' they exclaim, their
          eyes lighting up with newfound confidence.
        </p>
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          This isn't random luck; it's science. By operating in the Zone of
          Proximal Development, we create these 'aha' moments on demand. The
          session reveals not just what the child knows, but what they're ready
          to learn next.
        </p>
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          From that point, every tutoring session builds on this foundation,
          manufacturing more of these magical breakthroughs. No more 'I'm dumb'
          – just steady progress and growing belief in their abilities.
        </p>
        <p className="text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6">
          Want to see the magic for your child?
        </p>
        <button
